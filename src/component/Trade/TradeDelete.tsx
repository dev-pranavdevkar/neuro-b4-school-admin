...
export default function TradeDeletePopup({ show, handleclose, selectedTradeId }) {

    //..................API call to delete static page .................//

    const handleDelete = async () => {
        const id = selectedTradeId
        axiosInstance.delete(`/admin/tradeCall/delete/${id}`)
            .then(res => {
                ...
                toast.success('Trade Could Not Deleted ', {
                    position: 'top-center'
                })
            ...
            <Dialog fullWidth open={show} onClose={handleclose} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 512 } }}>
                <DialogContent sx={{ pb: 4 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                        ...
                        <Typography sx={{ fontSize: '1.125rem' }}>You won't be able to see this Trade!</Typography>
                    </Box>
                </DialogContent>
