...
export default function OptionTypeDeletePopup({ show, handleclose, selectedOptionTypeId }) {

    //..................API call to delete  .................//

    const handleDelete = async () => {
        const id = selectedOptionTypeId
        axiosInstance.delete(`/admin/optionType/delete/${id}`)
            .then(res => {
                ...
                toast.success('Option Type Could Not Deleted ', {
                    position: 'top-center'
                })
            ...
            <Dialog fullWidth open={show} onClose={handleclose} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 512 } }}>
                <DialogContent sx={{ pb: 4 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                        ...
                        <Typography sx={{ fontSize: '1.125rem' }}>You won't be able to see this Option!</Typography>
                    </Box>
                </DialogContent>
