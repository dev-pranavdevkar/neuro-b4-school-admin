...
export default function DeleteTeamMember({ show, handleclose, selectedTeamMemberId }) {

  //..................API call to delete Country page .................//

  const handleDelete = async () => {
    const id = selectedTeamMemberId
    axiosInstance.delete(`admin/v1/ourTeam/deleteTeam/${id}`)
      .then(res => {
        ...
        toast.error('Team Member Could Not Deleted ', {
          position: 'top-center'
        })
