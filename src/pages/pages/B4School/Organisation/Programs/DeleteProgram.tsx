...
export default function selectedProgram({ show, handleclose, selectedProgram }) {

  //..................API call to delete Country page .................//

  const handleDelete = async () => {
    const id = selectedProgram
    axiosInstance.delete(`admin/v1/ourProgram/deleteProgram/${id}`)
      .then(res => {
        ...
        toast.error('Program Could Not Deleted ', {
          position: 'top-center'
        })
