...
export default function DeleteCity({ show, handleclose, SelectedCityId }) {

  //..................API call to delete Country page .................//

  const handleDelete = async () => {
    const id = SelectedCityId
    axiosInstance.delete(`admin/v1/city/delete/${id}`)
      .then(res => {
        ...
        toast.error('City Could Not Deleted ', {
          position: 'top-center'
        })
