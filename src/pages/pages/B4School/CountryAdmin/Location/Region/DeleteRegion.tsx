...
export default function DeleteRegion({ show, handleclose, SelectedRegionId }) {

  //..................API call to delete Country page .................//

  const handleDelete = async () => {
    const id = SelectedRegionId
    axiosInstance.delete(`admin/v1/region/delete/${id}`)
      .then(res => {
        ...
        toast.error('Region Could Not Deleted ', {
          position: 'top-center'
        })
