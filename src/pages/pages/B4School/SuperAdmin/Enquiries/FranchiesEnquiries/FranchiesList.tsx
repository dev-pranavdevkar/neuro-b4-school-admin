...
class FranchiesList extends Component<{}, FranchiesList> {
  constructor(props: {}) {
    super(props);
    this.state = {
      rows: [],
  ...
  fetchData = () => {
    ...
    axiosInstance.get(`/admin/v1/enquiry/franchise/getAll?pageNo=${page}&limit=${pageSize}`)
      .then((response) => {
        this.setState({
