...
export default function CountryDeletePopup({ show, handleclose, selectedCountryId }) {

    //..................API call to delete Country page .................//

    const handleDelete = async () => {
        const id = selectedCountryId
        axiosInstance.delete(`/admin/v1/country/delete/${id}`)
            .then(res => {
                ...
                toast.error('Country Could Not Deleted ', {
                    position: 'top-center'
                })
