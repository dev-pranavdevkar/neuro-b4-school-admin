...
export default function DeleteBlog({ show, handleclose, selectedBlog }) {

  //..................API call to delete Blog page .................//
  console.log(selectedBlog)
  const handleDelete = async () => {
    const id = selectedBlog.id
    console.warn(selectedBlog);

    axiosInstance.delete(`/admin/v1/blog/delete/${id}`)
      .then(res => {
