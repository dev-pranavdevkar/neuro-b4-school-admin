...
export default function DeleteCountryAdmin({ show, handleclose, selectedCountryId }) {

  //..................API call to delete Country page .................//

  const handleDelete = async () => {
    const id = selectedCountryId
    axiosInstance.delete(`/admin/v1/countryAdmin/deleteById/${id}`)
      .then(res => {
        toast.success('Country Admin Deleted Successfully', {
          position: 'top-center'
        })
        handleclose()
      }).catch((error) => {
        toast.error('Country Admin Could Not Deleted ', {
          position: 'top-center'
        })
